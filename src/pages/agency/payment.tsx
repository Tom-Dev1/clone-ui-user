...
import { ChevronDown, ChevronUp, Search, ChevronsLeft, ChevronLeft, ChevronRight, ChevronsRight } from "lucide-react"
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="cursor-pointer" onClick={() => handleSortChange("serieNumber")}>
                                    <div className="flex items-center">
                                        Số serie
                                ...
                                <TableHead className="cursor-pointer text-right" onClick={() => handleSortChange("totalAmountPayment")}>
                                    <div className="flex items-center justify-end">
                                        Tổng tiền
                                        {renderSortIndicator("totalAmountPayment")}
                                    </div>
                                </TableHead>
                                <TableHead className="cursor-pointer text-right" onClick={() => handleSortChange("paymentAmount")}>
                                    <div className="flex items-center justify-end">
                                        Đã thanh toán
                                    ...
                                    <TableRow key={payment.paymentHistoryId}>
                                        ...
                                        <TableCell>
                                            {payment.status === "PARTIALLY_PAID" && (
                                                <Button variant="default" size="sm" onClick={() => openPaymentDialog(payment)}>
                                                    Thanh toán
                                                </Button>
                                            )}
                                        </TableCell>
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center justify-between p-4 border-t">
                            <div className="text-sm text-gray-500">
                                Hiển thị {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, filteredPayments.length)} của{" "}
