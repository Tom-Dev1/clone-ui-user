...
const CategoryList = () => {
    ...
    const handleUpdateCategory = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`https://minhlong.mlhr.org/api/product-category${selectedCategory.categoryId}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            const response = await fetch(`https://minhlong.mlhr.org/api/product-category${categoryToDelete.categoryId}`, {
                method: "DELETE",
                headers: {
                    Authorization: `Bearer ${token}`,
                },
                                ...
                                <div className="grid gap-4 py-4">
                                    ...
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        <div className="flex items-center space-x-2 col-span-3">
                                            ...
                                            />
                                            <Label htmlFor="isActive">{newCategory.isActive ? "Hoạt động" : "Không hoạt động"}</Label>
                                        </div>
                                    </div>
                                </div>
                                <DialogFooter>
                ...
                {selectedCategory && (
                    <DialogContent className="max-w-2xl">
                        ...
                        <div className="space-y-4 mt-4">
                            <div>
                                <h3 className="text-sm font-medium text-gray-500">ID danh mục</h3>
                                <p>{selectedCategory.categoryId}</p>
                            </div>

                            <div>
                                <h3 className="text-sm font-medium text-gray-500">Tên danh mục</h3>
                                <p className="text-lg font-semibold">{selectedCategory.categoryName}</p>
                            </div>

                            <div>
                                <h3 className="text-sm font-medium text-gray-500">Thứ tự sắp xếp</h3>
                            ...
                            <div>
                                ...
                                <span
                                    className={`px-2 py-1 rounded-full text-xs ${selectedCategory.isActive ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                        }`}
                                >
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <div className="flex items-center space-x-2 col-span-3">
                                        <Switch
                                            ...
                                            onCheckedChange={(checked) => handleSwitchChange(checked, "edit")}
                                        />
                                        <Label htmlFor="edit-isActive">{editCategory.isActive ? "Hoạt động" : "Không hoạt động"}</Label>
                                    </div>
                                </div>
                            </div>
                            <DialogFooter>
                ...
                {categoryToDelete && (
                    <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Bạn có chắc chắn muốn xóa danh mục "{categoryToDelete.categoryName}"? Hành động này không thể hoàn tác.
                            </DialogDescription>
                        </DialogHeader>
